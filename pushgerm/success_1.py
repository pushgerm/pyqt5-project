...
class App(QMainWindow):
    ...
    def loadData(self):
        ...
        if(fname[0:3] =="acc"):
            ...
            print("실행완료1")
            self.canvas_2.ax.set_xlim((0, 3000))
            print("실행완료2")
            self.canvas_2.ax.set_ylim((156, 170))
            print("실행완료3")
            self.canvas_2.ax.grid(True)
            print("실행완료4")
            line, = self.canvas_2.ax.plot([], [], lw = 1)
            print("실행완료5")
            ...
            print("실행완료6")
            ani = animation.FuncAnimation(fig = self.canvas_2.figure, func = animate, init_func = init, interval = 100, blit = True)
            print("실행완료8")
            self.canvas_2.draw()
...
class PlotCanvas(FigureCanvas):
    ...
    def plot_temp(self, time, x):
        ...
        def animate(t):
            x_axe = [i for i in range(0, t)]
            print(t)
            y = x[:t, 4:5]
            line.set_data(x_axe, x)
